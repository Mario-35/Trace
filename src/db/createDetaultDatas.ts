...
export async function createDetaultDatas() {
    ...
    VALUES 
      (
        ...
        '{"Créer","Prélevé","Stocké","Perdu","Detruit","Importé","Annulé", "Reprelevé"}',
   ...
   await executeSql(`INSERT INTO rpg ( code, valeur ) 
    VALUES ('NOT', 'Information non présente au sein du RPG'),
('01', 'Blé Tendre'),
('02', 'Mais Grain Et Ensilage'),
('03', 'Orge'),
('04', 'Autres Cereales'),
('05', 'Colza'),
('06', 'Tournesol'),
('07', 'Autres Oleagineux'),
('08', 'Proteagineux'),
('09', 'Plantes A Fibres'),
('10', 'Semences'),
...
('BLT', 'Bleuet'),
('BOP', 'Bois pâturé (prairie herbacée sous couvert d''arbres)'),
('BOR', 'Bordure de champ'),
('BRH', 'Bourrache de 5 ans ou moins'),
('BRO', 'Brôme de 5 ans ou moins'),
('BTA', 'Bande tampon'),
...
('CAB', 'Caroube'),
('CAC', 'Café / Cacao'),
('CAE', 'Châtaigneraie entretenue par des porcins ou des petits ruminants (Corse et Petite région des causses cévenols et méridionaux)'),
('CAF', 'Carotte fourragère'),
('CAG', 'Autre céréale ou pseudo céréale d’un autre genre'),
('CAR', 'Carotte'),
('CAV', 'Carvi'),
('CBT', 'Cerise bigarreau pour transformation'),
('CCN', 'Concombre / Cornichon'),
('CCT', 'Courgette / Citrouille'),
('CEE', 'Chênaie entretenue par des porcins ou des petits ruminants (Corse et Petite région des causses cévenols et méridionaux)'),
('CEL', 'Céleri'),
('CES', 'Chicorée / Endive / Scarole'),
...
('CRA', 'Cresson alénois de 5 ans ou moins'),
('CRD', 'Coriandre'),
('CRF', 'Cerfeuil'),
('CRN', 'Cornille'),
('CRS', 'Cresson'),
('CSA', 'Canne à sucre - autre'),
('CSE', 'Chanvre sans étiquette conforme'),
('CSF', 'Canne à sucre - fermage'),
('CSI', 'Canne à sucre - indivision'),
('CSP', 'Canne à sucre - propriété ou faire valoir direct'),
('CSR', 'Canne à sucre - réforme foncière'),
...
('HAR', 'Haricot / Flageolet'),
('HBL', 'Houblon'),
('HPC', 'Horticulture ornementale de plein champ'),
('HSA', 'Horticulture ornementale sous abri'),
('J5M', 'Jachère de 5 ans ou moins'),
('J6P', 'Jachère de 6 ans ou plus'),
('J6S', 'Jachère de 6 ans ou plus déclarée comme SIE'),
('JNO', 'Jachère noire'),
...
('LBF', 'Laitue / Batavia / Feuille de chêne'),
...
('MAC', 'Mâche'),
('MAV', 'Mauve'),
('MC6', 'Mélange de légumineuses fourragères prépondérantes implantées pour la récolte 2016 et de céréales'),
('MC7', 'Mélange de légumineuses fourragères prépondérantes implantées pour la récolte 2017 et de céréales et d''oléagineux'),
('MC8', 'Mélange de légumineuses fourragères prépondérantes implantées pour la récolte 2018 et de céréales et d''oléagineux'),
('MCR', 'Mélange de céréales ou pseudo céréales pures ou mélange avec des protéagineux non prépondérants'),
('MCT', 'Miscanthus'),
...
('MPC', 'Mélange de protéagineux prépondérants (pois et/ou lupin et/ou féverole) et de céréales'),
('MPP', 'Mélange de protéagineux (pois et/ou lupin et/ou féverole)'),
('MRG', 'Marguerite'),
('MRJ', 'Marjolaine / Origan'),
('MRS', 'Marais salant'),
('MTH', 'Menthe'),
('NOS', 'Noisette'),
('NOX', 'Noix'),
...
('PAN', 'Panais'),
('PAQ', 'Pâquerette'),
('PAR', 'Plante aromatique (autre que vanille)'),
('PAS', 'Pastèque'),
('PAT', 'Paturin commun de 5 ans ou moins'),
('PCH', 'Pois chiche'),
...
('PHI', 'Pois d''hiver'),
('PIS', 'Pistache'),
('PMD', 'Plante médicinale'),
('PMV', 'Primevère'),
('POR', 'Poireau'),
('POT', 'Potiron / Potimarron'),
...
('PPA', 'Autres plantes ornementales et PPAM annuelles'),
('PPF', 'Plante à parfum (autre que géranium et vétiver)'),
('PPH', 'Prairie permanente - herbe (ressources fourragères ligneuses absentes ou peu présentes)'),
('PPO', 'Pois (petits pois, pois cassés, pois gourmands)'),
('PPP', 'Autres plantes ornementales et PPAM pérennes'),
('PPR', 'Pois de printemps'),
('PRL', 'Prairie en rotation longue (6 ans ou plus)'),
('PRU', 'Prune d''Ente pour transformation'),
('PSE', 'Pensée'),
('PSL', 'Persil'),
('PSN', 'Psyllium noir de Provence'),
('PSY', 'Plantain psyllium'),
('PTC', 'Pomme de terre de consommation'),
('PTF', 'Pomme de terre féculière'),
...
('TOM', 'Tomate'),
('TOP', 'Topinambour'),
('TOT', 'Tomate pour transformation'),
...
('TRE', 'Autre trèfle'),
('TRN', 'Tournesol'),
('TRU', 'Truffière (plants mycorhizés)'),
...
('VNL', 'Vanille'),
('VNV', 'Vanille verte'),
('VRC', 'Vigne , raisins de cuve en production'),
('VRG', 'Autres vergers'),
('VRN', 'Vigne , raisins de cuve non en production'),
('VRT', 'Vigne , raisins de table'),
('XFE', 'X-Festulolium de 5 ans ou moins'),
('YLA', 'Ylang-ylang')`);
